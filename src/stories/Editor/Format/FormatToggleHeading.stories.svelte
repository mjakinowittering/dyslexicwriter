<script lang="ts" module>
    ...
    import FormatToggleHeading from '$lib/components/Editor/Format/FormatToggleHeading.svelte';

    import * as m from '$lib/paraglide/messages';

    const { Story } = defineMeta({
        title: 'Editor/Format/FormatToggleHeading',
...
>
    {#snippet template(args)}
        ...
        >
            <Format>
                <FormatGroup bind:formatting={heading2}>
                    <FormatToggleHeading
                        disabled={false}
                        editor={undefined}
                        level={1}
