<script lang="ts" module>
    ...
    import FormatInsertHorizontalRule from '$lib/components/ContentEditor/Format/FormatInsertHorizontalRule.svelte';

    import * as m from '$lib/paraglide/messages';

    const { Story } = defineMeta({
        title: 'ContentEditor/Format/FormatInsertHorizontalRule',
