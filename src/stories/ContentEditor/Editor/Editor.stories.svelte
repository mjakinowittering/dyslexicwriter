<script lang="ts" module>
    ...
    import Editor from '$lib/components/ContentEditor/Editor/Editor.svelte';

    const { Story } = defineMeta({
        title: 'ContentEditor/Editor/Editor',
        component: Editor,
        tags: ['autodocs'],
        argTypes: {
...
>
    {#snippet template(args)}
        <div class="bg-background min-h-96 w-full p-6">
            <Editor {...args} bind:editor={sansEditor} />
        </div>
    {/snippet}
</Story>
...
>
    {#snippet template(args)}
        <div class="bg-background min-h-96 w-full p-6">
            <Editor {...args} bind:editor={dyslexicEditor} />
        </div>
    {/snippet}
</Story>
