<script lang="ts" module>
    ...
    import ContentTimeToRead from '$lib/components/Content/ContentTimeToRead/ContentTimeToRead.svelte';

    import * as m from '$lib/paraglide/messages';
    import calculateReadingTime from '$lib/utils/calculateReadingTime';

    const { Story } = defineMeta({
        title: 'Content/ContentTimeToRead',
        component: ContentTimeToRead,
        tags: ['autodocs'],
        argTypes: {
